...
CREATE TABLE `Drill` (
    ...
    UNIQUE INDEX `Drill_name_key`(`name`),
    PRIMARY KEY (`name`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Player` (
    `name` VARCHAR(191) NOT NULL,
    `playerNumber` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `userId` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Stat` (
    `id` VARCHAR(191) NOT NULL,
    `leftMakes` VARCHAR(191) NULL,
    `leftTakes` VARCHAR(191) NULL,
    `rightMakes` VARCHAR(191) NULL,
    `rightTakes` VARCHAR(191) NULL,
    `singleMakes` VARCHAR(191) NULL,
    `singleTakes` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `drillName` VARCHAR(191) NOT NULL,
